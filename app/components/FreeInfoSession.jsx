          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <div className="space-y-4">
                   ...
                   <div>
                     <p className="text-3xl font-semibold" style={{color: '#0F172A'}}>9月20日（土）</p>
                     <p className="text-2xl" style={{color: '#475569'}}>9:30〜11:00 @Zoom</p>
                   </div>
                 </div>
                 <div className="flex items-start">
                   <div className="w-3 h-3 bg-gradient-to-r from-teal-500 to-blue-500 rounded-full mr-4 mt-2 flex-shrink-0"></div>
                   <div>
                     <p className="text-3xl font-semibold" style={{color: '#0F172A'}}>9月24日（水）</p>
                     <p className="text-2xl" style={{color: '#475569'}}>19:30〜21:00 @Zoom</p>
                   </div>
                 </div>
              </div>
            </div>
            ...
            <div className="text-center lg:text-left">
              <p className="text-lg mb-8" style={{color: '#0F172A', lineHeight: '1.7'}}>
                ファシリテーションやハピスクの詳細を知りたい方は、ぜひ説明会へ！
              </p>
                             <a 
                 href="https://forms.gle/MXJqWHQg1JLh5ZDa6" 
                 target="_blank" 
