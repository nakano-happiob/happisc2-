    ...
    <section id="about" className="section-space relative" style={{background: 'var(--brand-teal-soft)'}}>
      ...
      <div className="container-live relative z-10">
        <div className="text-center">
          <h2 className="title-lg mb-12">なぜ今、ファシリテーターが必要か？</h2>
          
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-lg">
                                   <div className="space-y-6 text-unified" style={{color: 'var(--text-strong)'}}>
                       <p>ハピオブではこれまで、企業・学校・地域など、150を超える場面で<br/>対話の場づくりをデザインしてきました。</p>
                       <p>また、どの場面でもファシリテーターが進行役を務め、<br/>コミュニケーションの円滑化を図ってきました。</p>
                       ...
                       <p>だからこそ今、<span style={{color: 'var(--brand-pink)'}}>ファシリテーター</span>の存在が注目されています。</p>
